  ...
  const socialLinks = [
    {
      ...
      url: 'https://facebook.com/vardrobe',
    },
    {
      name: 'Instagram',
      icon: (
      ...
      url: 'https://instagram.com/vardrobe',
    },
    {
      name: 'Pinterest',
      icon: (
      ...
      url: 'https://pinterest.com/vardrobe',
    },
    {
      name: 'YouTube',
      icon: (
      ...
      url: 'https://youtube.com/@vardrobe',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
          ...
          <div className="lg:col-span-2 mb-5">
            {/* Logo/Brand */}
          <Link to="/" className="flex-shrink-0 z-10 mb-5">
            <img 
              src={logo} 
              alt="VARDROBE Logo" 
